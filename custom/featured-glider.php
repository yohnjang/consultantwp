...
echo '</p>
	...
	echo '<li class="glide__slide grabbable">';
				...
				if(get_theme_mod('sparkle_featured_excerpt_1') != null){
					...
					<a class="btn btn-secondary sparkle-read-more-link light-text" href="https://www.consultantwp.com/consultancy-templates/benefit-page">Learn More</a>';
				}
...
if(get_theme_mod('sparkle_featured_headline_4') != null){
	...
	echo '<div class="featured_headline display-3">10 Ways that <i>primary audience</i> can solve <i>common problem</i></div>';
}
