<?php 
    if(get_theme_mod('sparkle_hero_image') != null ){
        ...
        echo '<div class="text">';
                    if(get_theme_mod('sparkle_typewriter_effect_switch') == 1 || get_theme_mod('sparkle_typewriter_effect_switch') == null ){
                        if( get_theme_mod('sparkle_hero_headline') != null ){
                            echo '<h1 id="typed" class="display-2"></h1>';
                        }
                        else{
                            echo '<h1 id="nulled_headline" class="display-2"></h1>';
                        }
                    }
                    else{
                        if(get_theme_mod('sparkle_hero_headline') != null){
                            echo '<h1 class="display-2">';
                            echo get_theme_mod('sparkle_hero_headline');
                            echo '</h1>';
                        }
                        else {
                            echo '<h1 class="display-2">';
...
<?php if(get_theme_mod('sparkle_hero_headline') == null ){ ?>
    ...
    var typeds = new Typed("#nulled_headline", optionss);
    </script>

<?php }else { ?>

    <script>
        var string = "<?php echo get_theme_mod('sparkle_hero_headline'); ?>"
    var options = {
        strings: [ string ],
        typeSpeed: 70,
        showCursor: false
