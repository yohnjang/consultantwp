...
echo '.medium-bg,#cta, footer#main #footer_newsletter input[type="submit"],#newsletter_section input[type="submit"],.cookiebanner{ background: '. $medium_bg_yellow . ' !important; }';
...
if( get_theme_mod('sparkle_hero_gradient_percent_mobile') != null){
	...
	echo '#static_hero:before { background: '. $super_dark_bg_yellow .';background: linear-gradient(90deg, '. $super_dark_bg_yellow .' 0%, '. $super_dark_bg_yellow .' 50%, transparent 100%);}';
}
...
if( get_theme_mod('sparkle_hero_gradient_percent_tablet') != null){
	...
	echo '@media only screen and (min-width:768px){ #static_hero:before {background: '. $super_dark_bg_yellow .';background: linear-gradient(90deg, '. $super_dark_bg_yellow .' 0%, '. $super_dark_bg_yellow .' 50%, transparent 100%);}}';
}
...
if( get_theme_mod('sparkle_hero_gradient_percent_desktop') != null){
	...
	echo '@media only screen and (min-width:1024px){ #static_hero:before { background: '. $super_dark_bg_yellow .';background: linear-gradient(90deg, '. $super_dark_bg_yellow .' 0%, '. $super_dark_bg_yellow .' 20%, transparent 100%);}}';
}
