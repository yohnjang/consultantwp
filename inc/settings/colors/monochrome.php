...
echo '.light-bg,#consultation, #newsletter_section, body,#primaryMenuWrapper.show,.hamburger-inner, .hamburger-inner::before, .hamburger-inner::after, #cta a.cta.button:hover{ background-color: ' . $light_bg_monochrome . ';}';

echo '.medium-bg,#cta,.btn-secondary:hover { background: '. $medium_bg_monochrome . '; }';
