  <?php
		...
		echo '.light-bg,#consultation, body,.hamburger-inner, .hamburger-inner::before, .hamburger-inner::after { background-color: ' . $light_bg_blue . ';}';
