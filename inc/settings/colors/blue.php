  <?php
		...
		echo '.light-bg,#consultation, body,.hamburger-inner, .hamburger-inner::before, .hamburger-inner::after, #cta a.cta.button:hover  , #newsletter_section button:hover, #footer_newsletter button:hover{ background-color: ' . $light_bg_blue . ';}';

		echo '#testimonials::before, #testimonials_glider::before, #newsletter_section button{ color: ' . $medium_color .';}';
		
		echo '.medium-bg,#cta, footer#main #footer_newsletter input[type="submit"],#newsletter_section input[type="submit"], #newsletter_section .btn-primary, #footer_newsletter .btn-primary,.btn-secondary:hover, #newsletter_section button, #footer_newsletter button { background: '. $medium_bg_blue . '; }';
		...
		echo '.dark-text,#consultation_form label,#footer_newsletter,.display-1,.display-2,.display-3,.display-4,.display-5,.display-6,h1,h2,h3,h4,h5,p, .entry-title a,#newsletter_section input[type="submit"], footer#main #footer_newsletter input[type="submit"], footer#main #footer_newsletter p, #cta a.cta.button:hover , #newsletter_section button:hover, #footer_newsletter button:hover{ color: '. $dark_text_blue . ' }';
