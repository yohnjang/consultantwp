...
echo '.dark-text, .entry-title a, #consultation .display-3 a, footer#main #footer_newsletter p, #cta a.cta.button:hover , #newsletter_section button:hover, #footer_newsletter button:hover{ color: '. $dark_text_purple . ' }';
...
if( get_theme_mod('sparkle_hero_gradient_percent_mobile') != null){
	...
	echo '#static_hero:before { background: '. $super_dark_bg_purple .';background: linear-gradient(90deg, '. $super_dark_bg_purple .' 0%, '. $super_dark_bg_purple .' 30%, transparent 100%);}';
}
...
if( get_theme_mod('sparkle_hero_gradient_percent_tablet') != null){
	...
	echo '@media only screen and (min-width:768px){ #static_hero:before {background: '. $super_dark_bg_purple .';background: linear-gradient(90deg, '. $super_dark_bg_purple .' 0%, '. $super_dark_bg_purple .' 30%, transparent 100%);}}';
}
...
if( get_theme_mod('sparkle_hero_gradient_percent_desktop') != null){
	...
	echo '@media only screen and (min-width:1024px){ #static_hero:before { background: '. $super_dark_bg_purple .';background: linear-gradient(90deg, '. $super_dark_bg_purple .' 0%, '. $super_dark_bg_purple .' 30%, transparent 100%);}}';
}
